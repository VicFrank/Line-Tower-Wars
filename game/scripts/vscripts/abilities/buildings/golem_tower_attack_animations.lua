golem_tower_attack_animations = class({})

LinkLuaModifier("modifier_golem_tower_attack_animations", "abilities/buildings/golem_tower_attack_animations", LUA_MODIFIER_MOTION_NONE)

function golem_tower_attack_animations:GetIntrinsicModifierName()
  return "modifier_golem_tower_attack_animations"
end

modifier_golem_tower_attack_animations = class({})

function modifier_golem_tower_attack_animations:IsHidden() return true end

function modifier_golem_tower_attack_animations:DeclareFunctions()
  local funcs = {
...
function modifier_golem_tower_attack_animations:GetEffectAttachType()
  return PATTACH_ABSORIGIN_FOLLOW
end

function modifier_golem_tower_attack_animations:GetOverrideAnimation()
  return ACT_DOTA_CUSTOM_TOWER_IDLE
end

function modifier_golem_tower_attack_animations:OnCreated()
...
function modifier_golem_tower_attack_animations:GetTrackingInterval()
  return 1/30 --Somewhere in building helper, it's told server fps is 30
end

function modifier_golem_tower_attack_animations:ShouldEndTracking()
...
function modifier_golem_tower_attack_animations:TrackTarget()
  if not IsServer() then return end
...
function modifier_golem_tower_attack_animations:OnAttackStart(keys)
  if not IsServer() then return end
...
function modifier_golem_tower_attack_animations:OnDeath(keys)
  if not IsServer() then return end
