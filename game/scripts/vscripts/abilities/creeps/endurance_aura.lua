endurance_aura = class({})

LinkLuaModifier("modifier_endurance_aura", "abilities/creeps/endurance_aura", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_endurance_aura_buff", "abilities/creeps/endurance_aura", LUA_MODIFIER_MOTION_NONE)

function endurance_aura:GetIntrinsicModifierName()
